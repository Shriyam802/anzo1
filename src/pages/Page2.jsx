...
const Page2 = function Page2() {
 ...
 gsap.registerPlugin(ScrollTrigger)
    ...
    // gsap.set(".rotatetext", { display: "block" }); 
})

  return (
    <div id='section2' className='bg-white text-black text-center p-10'>
    
        
       
       
        <h1 className='text-gray-500 text-2xl font-[anzo1]'>© 2025 Anzo.Studio® | designed and developed</h1>
        
        
        <div className='rotatetext mt-20'>
            <h1 className='text-black text-[45vw] font-[anzo] leading-[35vw]'>IMPACTFUL</h1>
        </div>
        <div className='rotatetext'>
            <h1 className='text-[45vw] font-[anzo] leading-[35vw]'>DESIGN</h1>
        </div>
        <div className='rotatetext'>
            <h1 className='text-[45vw] font-[anzo] leading-[35vw]'>IS THE</h1>
        </div>
        <div className='rotatetext'>
            <h1 className='text-[45vw] font-[anzo] leading-[35vw]'>DESIGN</h1>
        </div>
        <div className='rotatetext'>
            <h1 className='text-[45vw] font-[anzo] leading-[35vw]'>THAT</h1>
        </div>
        <div className='rotatetext'>
            <h1 className='text-[45vw] font-[anzo] leading-[35vw]'>WORKS!</h1>
        </div>
